"""
Un programa que guardara informacion de libros como:
Titulo ,Autor , Año , ISBN

El usuario podra:
Ver todos los libros, buscaslos , agregar y actualizar libros, eliminar
y cerrar el programa
"""

from tkinter import *
# para importar la clase lo hacemos de esta manera
from backend import Database
# enviamos el nombre de la base de datos a backend
...
class Window(object):
    ...
    def __init__(self, window):
        ...
        b4 = Button(window, text="Updated selected",
    ...
    def view_command(self):  # TODOS falta enumerar
